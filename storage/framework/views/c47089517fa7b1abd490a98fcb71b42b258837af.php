			...
			<nav class="navbar navbar-default" role="navigation">
				...
				<div>
					<ul class="nav navbar-nav navbar-right">
						...
						<?php if(Auth::guest()): ?>
	                        <li><a href="<?php echo e(url('/login')); ?>"><span class="userlink">登录</span></a></li>
	                        <li><a href="#"><span class="userlink">注册</span></a></li>
                    	<?php else: ?>
	                        <li>
	                        	<a href="<?php echo e(url('/login')); ?>"><span class="userlink"><?php echo e(Auth::user()->name); ?></span></a>
	                        </li>
	                        <li><a href="<?php echo e(url('/logout')); ?>"><span class="userlink">注销</span></a></li>
                    	<?php endif; ?>	
